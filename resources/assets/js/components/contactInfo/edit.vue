                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8  form-inline">
                            <address-info v-if="loaded" :can_options="can_options"
                                :id="parseInt(form.contactInfo.contactAddress)" name="通訊地址"
                    ...
                    <div v-show="show_residence"  class="form-group">
                        ...
                        <div class="col-md-8 form-inline">
                            <address-info v-if="loaded" :can_options="can_options"
                                :id="parseInt(form.contactInfo.residenceAddress)" name="戶籍地址"
