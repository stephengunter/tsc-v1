...
export default {
   ...
   methods: {
      init(){
         if(this.params){
            if(this.params.hasOwnProperty('term')){
               this.search_params.term = this.params.term
            }
            if(this.params.hasOwnProperty('center')){
               this.search_params.center = this.params.center
            }
         }
      },
