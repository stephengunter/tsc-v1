<template>
<div>
  <admin v-show="loaded" :id="id" 
      :version="version" :can_edit="can_edit" :can_back="can_back"  
      @saved="onAdminUpdated" @data-loaded="onDataLoaded"
      @btn-back-clicked="onBtnBackClicked" @deleted="onAdminDeleted" > 

  </admin>

  <div v-if="loaded" id="tabAdmin" class="panel with-nav-tabs panel-default">
