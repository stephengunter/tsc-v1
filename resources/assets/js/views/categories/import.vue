<template>
    ...
    <div class="panel panel-default">
        <div class="panel-heading ">           
            ...
            <a href="/downloads?type=import&key=categories" target="_blank" class="btn btn-default btn-primary">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                title:Helper.getIcon('categories')  + '  Excel 匯入課程分類',
        ...
        methods: {
            ...
            submitImport() {
                ...
                for (let i = 0; i < this.files.length; i++) {
                    form.append('categories_file', this.files[i])
